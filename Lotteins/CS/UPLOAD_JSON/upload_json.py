...
"""program"""
__author__ = "MINDsLAB"
__date__ = "creation: 2018-04-06, modification: 2018-04-06"
...
class Oracle(object):
    ...
    def check_tb_cs_stt_rcdg_info(self, rec_id, rfile_name):
        try:
            query = """
                SELECT
                    *
    ...
    def insert_data_to_rcdg_info(self, **kwargs):
        try:
            query = """
                INSERT INTO TB_CS_STT_RCDG_INFO
                (
                    REC_ID,
                    RFILE_NAME,
                    CS_STTA_PRGST_CD,
                ...
                VALUES (
                    :1, :2, :3, SYSDATE, :4, :5, :6, :7, :8, TO_DATE(:9, 'YYYY/MM/DD HH24:MI:SS'), 
                    TO_DATE(:10, 'YYYY/MM/DD HH24:MI:SS'), :11, :12, :13, :14, :15, M2U_MASKING_NAME(:16), 
                    M2U_CRYPTO_SHA256_ENCRYPT(:17), :18, :19, :20, :21, :22, :23, :24, :25, SYSDATE, :26, :27, SYSDATE
                )
            """
            bind = (
                kwargs.get('rec_id'),
                kwargs.get('rfile_name'),
                kwargs.get('cs_stta_prgst_cd'),
        ...
        try:
            query = """
                ...
                SET
                    ...
                    CTI_CALL_ID = :5,
                    CALL_TYPE = :6,
                    CALL_START_TIME = TO_DATE(:7, 'YYYY/MM/DD HH24:MI:SS'),
                    CALL_END_TIME = TO_DATE(:8, 'YYYY/MM/DD HH24:MI:SS'),
                    CALL_DURATION = :9,
                    RUSER_ID = :10,
                    RUSER_NAME = :11,
                    RUSER_NUMBER = :12,
                    CU_ID = :13,
                    CU_NAME = M2U_MASKING_NAME(:14),
                    CU_NAME_HASH = M2U_CRYPTO_SHA256_ENCRYPT(:15),
                    CU_NUMBER = :16,
                    IN_CALL_NUMBER = :17,
                    BIZ_CD = :18,
                    CHN_TP = :19,
                    ...
                    LST_CHG_DTM = SYSDATE
                WHERE 1=1
                    AND TB_CS_STT_RCDG_INFO.REC_ID = :24
                    AND TB_CS_STT_RCDG_INFO.RFILE_NAME = :25
            """
            bind = (
                kwargs.get('cs_stta_prgst_cd'),
                kwargs.get('stt_cmdtm'),
