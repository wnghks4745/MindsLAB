...
CONFIG = {
    'log_dir_path': '/log/MindsVOC/TM/TA/INSERT_STATISTICS_TABLES'
    , 'log_file_name': 'insert_statistics_tables.log'
}
...
OPENSSL_CONFIG = {
    'codec_file_path': '/app/prd/MindsVOC/TM/TA/Kbli/BATCH/INSERT_STATISTICS_TABLES/cfg/codec.cfg'
}