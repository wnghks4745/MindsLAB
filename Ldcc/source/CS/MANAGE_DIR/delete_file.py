...
from service.config import MANAGE_DIR_CONFIG
...
def processing(target_dir_list):
    ...
    # Add logging
    logger_args = {
        'base_path': MANAGE_DIR_CONFIG['log_dir_path'],
        'log_file_name': MANAGE_DIR_CONFIG['log_file_name'],
        'log_level': MANAGE_DIR_CONFIG['log_level']
    }
...
def main(args):
    ...
    try:
        if args.target_dir_path and args.delete_file_date:
            ...
            target_dir_list = MANAGE_DIR_CONFIG['target_directory_list']
        else:
